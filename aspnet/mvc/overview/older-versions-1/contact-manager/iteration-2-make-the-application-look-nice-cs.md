...
---
# <a name="iteration-2--make-the-application-look-nice-c"></a>迭代 2 – 使应用程序外表美观 (C#)
...
**图 01**： ASP.NET mVC 应用程序的默认外观（[单击以查看全尺寸图像](iteration-2-make-the-application-look-nice-cs/_static/image2.png)）
...
**图02**： ASP.NET MVC 设计库 （[单击以查看全尺寸图像](iteration-2-make-the-application-look-nice-cs/_static/image4.png)）
...
**图 03**： 取消阻止从 Web 下载的文件 （[单击以查看全尺寸图像](iteration-2-make-the-application-look-nice-cs/_static/image6.png)）
...
**图 04**： 解决方案资源管理器中的覆盖文件 （[单击以查看全尺寸图像](iteration-2-make-the-application-look-nice-cs/_static/image8.png)）
...
**图 05**： 将 [项目名称] 替换为联系人管理器 （[单击以查看全尺寸图像](iteration-2-make-the-application-look-nice-cs/_static/image10.png)）
...
**图 06**： 使用 10 月模板联系经理 （[单击以查看全尺寸图像](iteration-2-make-the-application-look-nice-cs/_static/image12.png)）
...
**图07**： ASP.NET MVC 联系人管理器设计 （[单击以查看全尺寸图像](iteration-2-make-the-application-look-nice-cs/_static/image14.png)）
...
**图 08**：选定和未选中的选项卡（[单击以查看全尺寸图像](iteration-2-make-the-application-look-nice-cs/_static/image16.png)）
