...
**图 01**： 新项目对话框（[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image2.png)）
...
**图 02**： 创建单元测试项目对话框 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image4.png)）
...
**图 03**： 解决方案资源管理器窗口 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image6.png)）
...
**图04**：创建新的微软 SQL Server Express 数据库 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image8.png)）
...
**图 05**： 数据库表设计器 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image10.png)）
...
**图 06**： 添加新项目对话框 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image12.png)）
...
**图 07**： 选择模型内容 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image14.png)）
...
**图 08**： 选择您的数据连接 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image16.png)）
...
**图 09**： 选择数据库对象 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image18.png)）
...
**图10**： 联系人类 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image20.png)）
...
**图11**： 添加主控制器 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image22.png)）
...
**图 12**： 添加索引视图 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image24.png)）

在 **"添加视图"** 对话框中，选中标记为"**创建强类型视图"复选框**。 选择"查看数据类联系人管理器.联系人"和"查看内容列表"。 选择这些选项将生成显示联系人记录列表的视图。
...
**图 13**： 添加视图对话框 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image26.png)）
...
**图14**：启用调试 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image28.png)）
...
**图 15**： 索引视图 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image30.png)）
...
**清单4 - 控制器\homeController.vb（使用创建方法）**
...
**图 16**： 添加创建视图 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image32.png)）

在 **"添加视图"** 对话框中，选择 **"联系人管理器.联系人"** 类和"创建视图内容 **"** 选项（参见图 17）。 单击"**添加**"按钮时，将自动生成"创建"视图。
...
**图17**： 看到页面爆炸 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image34.png)）
...
**图 19**： 添加编辑视图 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image38.png)）
...
**图20**：删除确认视图 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image40.png)）
...
**图21**：索引视图与编辑链接 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image42.png)）
...
**图22**：添加删除确认视图 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image44.png)）
...
此问题很容易解决。 首先，我们需要重构主控制器的名称。 在 Visual Studio 代码编辑器中打开 HomeController 类，右键单击类的名称并选择菜单选项 **"重命名**"。 选择此菜单选项将打开"重命名"对话框。
...
**图23**：重构控制器名称 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image46.png)）
...
**图24**：使用重命名对话框 （[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image48.png)）
...
**图25：** 无默认控制器（[单击以查看全尺寸图像](iteration-1-create-the-application-vb/_static/image50.png)）
