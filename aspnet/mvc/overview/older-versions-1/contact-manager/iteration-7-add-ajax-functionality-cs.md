...
**图 01**：仅更新联系人（[单击以查看全尺寸图像](iteration-7-add-ajax-functionality-cs/_static/image2.png)）
...
**图 02**： 删除确认页（[单击以查看全尺寸图像](iteration-7-add-ajax-functionality-cs/_static/image4.png)）
