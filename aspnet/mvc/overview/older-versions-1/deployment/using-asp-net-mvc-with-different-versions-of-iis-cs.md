...
**图1：** 检测请求处理模式（[单击以查看全尺寸图像](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image2.png)）
...
**图2**： 收到 404 未找到错误（[单击以查看全尺寸图像](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image4.png)）
...
**重要提示**：在更改 Global.asax 文件后，请记住再次构建ASP.NET MVC 应用程序。
...
**图 3**： 使用 IIS 7.0 创建通配符脚本映射（[单击以查看全尺寸图像](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image6.png)）
...
**图 4**： 使用 IIS 6.0 创建通配符脚本映射（[单击以查看全尺寸图像](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image8.png)）
...
**图 5**： 缺少根路由错误（[单击以查看全尺寸图像](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image10.png)）
