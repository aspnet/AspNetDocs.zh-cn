...
<span data-ttu-id="8dfb9-113">**[CDN 上的第三方文件](#Third-Party_Files_on_the_CDN_23)**</span><span class="sxs-lookup"><span data-stu-id="8dfb9-113">**[Third-Party Files on the CDN](#Third-Party_Files_on_the_CDN_23)**</span></span>  
...
<span data-ttu-id="8dfb9-135">利用 CDN，可以显著提高 Ajax 应用程序的性能。</span><span class="sxs-lookup"><span data-stu-id="8dfb9-135">By taking advantage of the CDN, you can significantly improve the performance of your Ajax applications.</span></span> <span data-ttu-id="8dfb9-136">CDN 的内容缓存在位于世界各地的服务器上。</span><span class="sxs-lookup"><span data-stu-id="8dfb9-136">The contents of the CDN are cached on servers located around the world.</span></span> <span data-ttu-id="8dfb9-137">此外，CDN 还允许浏览器对位于不同域中的网站重用缓存的第三方 JavaScript 文件。</span><span class="sxs-lookup"><span data-stu-id="8dfb9-137">In addition, the CDN enables browsers to reuse cached third party JavaScript files for web sites that are located in different domains.</span></span>
...
#### <a name="jquery-version-340"></a><span data-ttu-id="8dfb9-204">jQuery 版本3.4。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-204">jQuery version 3.4.0</span></span>
...
#### <a name="jquery-version-310"></a><span data-ttu-id="8dfb9-209">jQuery 版本3.1。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-209">jQuery version 3.1.0</span></span>
...
#### <a name="jquery-version-220"></a><span data-ttu-id="8dfb9-215">jQuery 版本2.2。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-215">jQuery version 2.2.0</span></span>
...
#### <a name="jquery-version-202"></a><span data-ttu-id="8dfb9-222">jQuery 版本2.0。2</span><span class="sxs-lookup"><span data-stu-id="8dfb9-222">jQuery version 2.0.2</span></span>
...
#### <a name="jquery-version-1121"></a><span data-ttu-id="8dfb9-228">jQuery 版本1.12。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-228">jQuery version 1.12.1</span></span>
...
#### <a name="jquery-version-1102"></a><span data-ttu-id="8dfb9-234">jQuery 版本1.10。2</span><span class="sxs-lookup"><span data-stu-id="8dfb9-234">jQuery version 1.10.2</span></span>
...
#### <a name="jquery-version-182"></a><span data-ttu-id="8dfb9-240">jQuery 版本1.8。2</span><span class="sxs-lookup"><span data-stu-id="8dfb9-240">jQuery version 1.8.2</span></span>
...
#### <a name="jquery-version-163"></a><span data-ttu-id="8dfb9-247">jQuery 版本1.6。3</span><span class="sxs-lookup"><span data-stu-id="8dfb9-247">jQuery version 1.6.3</span></span>
...
#### <a name="jquery-version-144"></a><span data-ttu-id="8dfb9-254">jQuery 版本 sqoop-user-guide-1.4。4</span><span class="sxs-lookup"><span data-stu-id="8dfb9-254">jQuery version 1.4.4</span></span>
...
<span data-ttu-id="8dfb9-261">以下版本的 jQuery 迁移在 CDN 上托管：</span><span class="sxs-lookup"><span data-stu-id="8dfb9-261">The following releases of jQuery Migrate are hosted on the CDN:</span></span>
...
- [<span data-ttu-id="8dfb9-290">jQuery UI 1.8.20</span><span class="sxs-lookup"><span data-stu-id="8dfb9-290">jQuery UI 1.8.20</span></span>](jquery-ui/cdnjqueryui1820.md "Microsoft Ajax CDN 的 jQuery UI 1.8.20")
...
- [<span data-ttu-id="8dfb9-328">jQuery 验证 1.5.5</span><span class="sxs-lookup"><span data-stu-id="8dfb9-328">jQuery Validate 1.5.5</span></span>](jquery-validate/cdnjqueryvalidate155.md "jQuery 验证 1.5.5")
...
- [<span data-ttu-id="8dfb9-348">jQuery Mobile 1.0 beta 3</span><span class="sxs-lookup"><span data-stu-id="8dfb9-348">jQuery Mobile 1.0 beta 3</span></span>](jquery-mobile/cdnjquerymobile10b3.md "Microsoft Ajax CDN 的 jQuery Mobile 1.0 Beta 3")
...
- [<span data-ttu-id="8dfb9-367">jQuery DataTables 1.9.1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-367">jQuery DataTables 1.9.1</span></span>](jquery-datatables/cdnjquerydatatables191.md "jQuery DataTables 1.9.1")
...
### <a name="globalize-releases-on-the-cdn"></a><span data-ttu-id="8dfb9-376">CDN 上的全球化版本</span><span class="sxs-lookup"><span data-stu-id="8dfb9-376">Globalize Releases on the CDN</span></span>

<span data-ttu-id="8dfb9-377">在 CDN 上托管以下版本的[全球](https://github.com/jquery/globalize "全球化")化：</span><span class="sxs-lookup"><span data-stu-id="8dfb9-377">The following releases of [Globalize](https://github.com/jquery/globalize "Globalize") are hosted on the CDN:</span></span>

#### <a name="globalize-version-100"></a><span data-ttu-id="8dfb9-378">全球化版本1.0。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-378">Globalize version 1.0.0</span></span>
...
#### <a name="globalize-version-011"></a><span data-ttu-id="8dfb9-379">全球化版本0.1。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-379">Globalize version 0.1.1</span></span>

- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/globalize.min.js
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/globalize.js
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/cultures/globalize.cultures.js

    - <span data-ttu-id="8dfb9-380">所有区域性</span><span class="sxs-lookup"><span data-stu-id="8dfb9-380">all cultures</span></span>
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/cultures/globalize.culture.{culture-code}.js

    - <span data-ttu-id="8dfb9-381">使用所需的区域性代码（例如 globalize.culture.en-GB.js= = CDN 上的 Microsoft 文件）替换 "{culture-code}"。 Microsoft 上传了这些库。</span><span class="sxs-lookup"><span data-stu-id="8dfb9-381">Replace "{culture-code}" with the desired culture code, e.g. globalize.culture.en-GB.js== Microsoft Files on the CDN ==These libraries were uploaded by Microsoft.</span></span>

<a id="Respond_Releases_on_the_CDN_13"></a>

### <a name="respond-releases-on-the-cdn"></a><span data-ttu-id="8dfb9-382">在 CDN 上响应发布</span><span class="sxs-lookup"><span data-stu-id="8dfb9-382">Respond Releases on the CDN</span></span>

<span data-ttu-id="8dfb9-383">以下版本的[响应](https://github.com/scottjehl/Respond "响应")在 CDN 上托管：</span><span class="sxs-lookup"><span data-stu-id="8dfb9-383">The following releases of [Respond](https://github.com/scottjehl/Respond "Respond") are hosted on the CDN:</span></span>

#### <a name="respond-version-142"></a><span data-ttu-id="8dfb9-384">响应版本1.4。2</span><span class="sxs-lookup"><span data-stu-id="8dfb9-384">Respond version 1.4.2</span></span>
...
#### <a name="respond-version-141"></a><span data-ttu-id="8dfb9-385">响应版本1.4。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-385">Respond version 1.4.1</span></span>
...
#### <a name="respond-version-140"></a><span data-ttu-id="8dfb9-386">响应版本1.4。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-386">Respond version 1.4.0</span></span>
...
#### <a name="respond-version-130"></a><span data-ttu-id="8dfb9-387">响应版本1.3。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-387">Respond version 1.3.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.3.0/respond.js

#### <a name="respond-version-120"></a><span data-ttu-id="8dfb9-388">响应版本1.2。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-388">Respond version 1.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.2.0/respond.js

<a id="Bootstrap_Releases_on_the_CDN_14"></a>

### <a name="bootstrap-releases-on-the-cdn"></a><span data-ttu-id="8dfb9-389">CDN 上的启动版本</span><span class="sxs-lookup"><span data-stu-id="8dfb9-389">Bootstrap Releases on the CDN</span></span>

<span data-ttu-id="8dfb9-390">以下版本的[getbootstrap.com](http://getbootstrap.com "getbootstrap.com")启动在 CDN 上托管：</span><span class="sxs-lookup"><span data-stu-id="8dfb9-390">The following releases of [getbootstrap.com](http://getbootstrap.com "getbootstrap.com") bootstrap are hosted on the CDN:</span></span>

#### <a name="bootstrap-version-450"></a><span data-ttu-id="8dfb9-391">启动版本4.5。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-391">Bootstrap version 4.5.0</span></span>
...
#### <a name="bootstrap-version-441"></a><span data-ttu-id="8dfb9-392">启动版本4.4。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-392">Bootstrap version 4.4.1</span></span>
...
#### <a name="bootstrap-version-431"></a><span data-ttu-id="8dfb9-393">启动版本4.3。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-393">Bootstrap version 4.3.1</span></span>
...
#### <a name="bootstrap-version-421"></a><span data-ttu-id="8dfb9-394">启动版本4.2。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-394">Bootstrap version 4.2.1</span></span>
...
#### <a name="bootstrap-version-411"></a><span data-ttu-id="8dfb9-395">启动版本4.1。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-395">Bootstrap version 4.1.1</span></span>
...
#### <a name="bootstrap-version-400"></a><span data-ttu-id="8dfb9-396">启动版本4.0。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-396">Bootstrap version 4.0.0</span></span>
...
#### <a name="bootstrap-version-341"></a><span data-ttu-id="8dfb9-397">启动版本3.4。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-397">Bootstrap version 3.4.1</span></span>
...
#### <a name="bootstrap-version-340"></a><span data-ttu-id="8dfb9-398">启动版本3.4。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-398">Bootstrap version 3.4.0</span></span>
...
#### <a name="bootstrap-version-337"></a><span data-ttu-id="8dfb9-399">启动版本3.3。7</span><span class="sxs-lookup"><span data-stu-id="8dfb9-399">Bootstrap version 3.3.7</span></span>
...
#### <a name="bootstrap-version-336"></a><span data-ttu-id="8dfb9-400">启动版本3.3。6</span><span class="sxs-lookup"><span data-stu-id="8dfb9-400">Bootstrap version 3.3.6</span></span>
...
#### <a name="bootstrap-version-335"></a><span data-ttu-id="8dfb9-401">启动版本3.3。5</span><span class="sxs-lookup"><span data-stu-id="8dfb9-401">Bootstrap version 3.3.5</span></span>
...
#### <a name="bootstrap-version-334"></a><span data-ttu-id="8dfb9-402">启动版本3.3。4</span><span class="sxs-lookup"><span data-stu-id="8dfb9-402">Bootstrap version 3.3.4</span></span>
...
#### <a name="bootstrap-version-332"></a><span data-ttu-id="8dfb9-403">启动版本3.3。2</span><span class="sxs-lookup"><span data-stu-id="8dfb9-403">Bootstrap version 3.3.2</span></span>
...
#### <a name="bootstrap-version-331"></a><span data-ttu-id="8dfb9-404">启动版本3.3。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-404">Bootstrap version 3.3.1</span></span>
...
#### <a name="bootstrap-version-330"></a><span data-ttu-id="8dfb9-405">启动版本3.3。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-405">Bootstrap version 3.3.0</span></span>
...
#### <a name="bootstrap-version-320"></a><span data-ttu-id="8dfb9-406">启动版本3.2。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-406">Bootstrap version 3.2.0</span></span>
...
#### <a name="bootstrap-version-311"></a><span data-ttu-id="8dfb9-407">启动版本3.1。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-407">Bootstrap version 3.1.1</span></span>
...
#### <a name="bootstrap-version-310"></a><span data-ttu-id="8dfb9-408">启动版本3.1。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-408">Bootstrap version 3.1.0</span></span>
...
#### <a name="bootstrap-version-303"></a><span data-ttu-id="8dfb9-409">启动版本3.0。3</span><span class="sxs-lookup"><span data-stu-id="8dfb9-409">Bootstrap version 3.0.3</span></span>
...
#### <a name="bootstrap-version-302"></a><span data-ttu-id="8dfb9-410">启动版本3.0。2</span><span class="sxs-lookup"><span data-stu-id="8dfb9-410">Bootstrap version 3.0.2</span></span>
...
#### <a name="bootstrap-version-301"></a><span data-ttu-id="8dfb9-411">启动版本3.0。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-411">Bootstrap version 3.0.1</span></span>
...
#### <a name="bootstrap-version-300"></a><span data-ttu-id="8dfb9-412">启动版本3.0。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-412">Bootstrap version 3.0.0</span></span>
...
#### <a name="bootstrap-version-232"></a><span data-ttu-id="8dfb9-413">启动版本2.3。2</span><span class="sxs-lookup"><span data-stu-id="8dfb9-413">Bootstrap version 2.3.2</span></span>
...
#### <a name="bootstrap-version-231"></a><span data-ttu-id="8dfb9-414">启动版本2.3。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-414">Bootstrap version 2.3.1</span></span>
...
### <a name="bootstrap-touchcarousel-releases-on-the-cdn"></a><span data-ttu-id="8dfb9-415">CDN 上的启动 TouchCarousel 版本</span><span class="sxs-lookup"><span data-stu-id="8dfb9-415">Bootstrap TouchCarousel Releases on the CDN</span></span>

<span data-ttu-id="8dfb9-416">以下版本的 [https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") 启动 TouchCarousel 版本托管在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="8dfb9-416">The following releases of [https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") Bootstrap TouchCarousel releases are hosted on the CDN:</span></span>

#### <a name="bootstrap-touchcarousel-version-080"></a><span data-ttu-id="8dfb9-417">启动 TouchCarousel 版本0.8。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-417">Bootstrap TouchCarousel version 0.8.0</span></span>
...
### <a name="hammerjs-releases-on-the-cdn"></a><span data-ttu-id="8dfb9-418">CDN 上的 Hammer.js 版本</span><span class="sxs-lookup"><span data-stu-id="8dfb9-418">Hammer.js Releases on the CDN</span></span>

<span data-ttu-id="8dfb9-419">以下版本的 [http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js 版本托管在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="8dfb9-419">The following releases of [http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js releases are hosted on the CDN:</span></span>

#### <a name="hammerjs-version-204"></a><span data-ttu-id="8dfb9-420">Hammer.js 版本2.0。4</span><span class="sxs-lookup"><span data-stu-id="8dfb9-420">Hammer.js version 2.0.4</span></span>
...
### <a name="aspnet-web-forms-and-ajax-releases-on-the-cdn"></a><span data-ttu-id="8dfb9-421">CDN 上的 ASP.NET Web 窗体和 Ajax 版本</span><span class="sxs-lookup"><span data-stu-id="8dfb9-421">ASP.NET Web Forms and Ajax Releases on the CDN</span></span>

<span data-ttu-id="8dfb9-422">以下版本的 ASP.NET Ajax 库托管在 CDN 上。</span><span class="sxs-lookup"><span data-stu-id="8dfb9-422">The following releases of the ASP.NET Ajax Library are hosted on the CDN.</span></span> <span data-ttu-id="8dfb9-423">单击每个链接以查看文件的实际列表。</span><span class="sxs-lookup"><span data-stu-id="8dfb9-423">Click each link to see the actual list of files.</span></span>

- [<span data-ttu-id="8dfb9-424">ASP.NET Web 窗体和 Ajax 版本4.5。2</span><span class="sxs-lookup"><span data-stu-id="8dfb9-424">ASP.NET Web Forms and Ajax version 4.5.2</span></span>](cdnajax452.md "ASP.NET Web 窗体和 Ajax 4.5.2")
- [<span data-ttu-id="8dfb9-425">ASP.NET Web 窗体和 Ajax 版本4</span><span class="sxs-lookup"><span data-stu-id="8dfb9-425">ASP.NET Web Forms and Ajax version 4</span></span>](cdnajax4.md "ASP.NET Web 窗体和 Ajax 4")
- [<span data-ttu-id="8dfb9-426">ASP.NET Ajax 3.5 版</span><span class="sxs-lookup"><span data-stu-id="8dfb9-426">ASP.NET Ajax version 3.5</span></span>](cdnajax35.md "ASP.NET Ajax 3.5")

<a id="ASPNET_MVC_Releases_on_the_CDN_16"></a>

### <a name="aspnet-mvc-releases-on-the-cdn"></a><span data-ttu-id="8dfb9-427">CDN 上的 ASP.NET MVC 版本</span><span class="sxs-lookup"><span data-stu-id="8dfb9-427">ASP.NET MVC Releases on the CDN</span></span>

<span data-ttu-id="8dfb9-428">以下 ASP.NET MVC JavaScript 文件托管在此 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="8dfb9-428">The following ASP.NET MVC JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-mvc-523"></a><span data-ttu-id="8dfb9-429">ASP.NET MVC 5.2。3</span><span class="sxs-lookup"><span data-stu-id="8dfb9-429">ASP.NET MVC 5.2.3</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-51"></a><span data-ttu-id="8dfb9-430">ASP.NET MVC 5。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-430">ASP.NET MVC 5.1</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-50"></a><span data-ttu-id="8dfb9-431">ASP.NET MVC 5。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-431">ASP.NET MVC 5.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-40"></a><span data-ttu-id="8dfb9-432">ASP.NET MVC 4.0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-432">ASP.NET MVC 4.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-30"></a><span data-ttu-id="8dfb9-433">ASP.NET MVC 3.0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-433">ASP.NET MVC 3.0</span></span>
...
#### <a name="aspnet-mvc-20"></a><span data-ttu-id="8dfb9-434">ASP.NET MVC 2。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-434">ASP.NET MVC 2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.js
- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.debug.js

#### <a name="aspnet-mvc-10"></a><span data-ttu-id="8dfb9-435">ASP.NET MVC 1。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-435">ASP.NET MVC 1.0</span></span>
...
### <a name="aspnet-signalr-releases-on-the-cdn"></a><span data-ttu-id="8dfb9-436">CDN 上的 ASP.NET SignalR</span><span class="sxs-lookup"><span data-stu-id="8dfb9-436">ASP.NET SignalR Releases on the CDN</span></span>

<span data-ttu-id="8dfb9-437">以下 ASP.NET SignalR JavaScript 文件托管在此 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="8dfb9-437">The following ASP.NET SignalR JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-signalr-222"></a><span data-ttu-id="8dfb9-438">ASP.NET SignalR 2.2。2</span><span class="sxs-lookup"><span data-stu-id="8dfb9-438">ASP.NET SignalR 2.2.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.js

#### <a name="aspnet-signalr-221"></a><span data-ttu-id="8dfb9-439">ASP.NET SignalR 2.2。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-439">ASP.NET SignalR 2.2.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.js

#### <a name="aspnet-signalr-220"></a><span data-ttu-id="8dfb9-440">ASP.NET SignalR 2.2。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-440">ASP.NET SignalR 2.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.js

#### <a name="aspnet-signalr-210"></a><span data-ttu-id="8dfb9-441">ASP.NET SignalR 2.1。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-441">ASP.NET SignalR 2.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.js

#### <a name="aspnet-signalr-203"></a><span data-ttu-id="8dfb9-442">ASP.NET SignalR 2.0。3</span><span class="sxs-lookup"><span data-stu-id="8dfb9-442">ASP.NET SignalR 2.0.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.js

#### <a name="aspnet-signalr-202"></a><span data-ttu-id="8dfb9-443">ASP.NET SignalR 2.0。2</span><span class="sxs-lookup"><span data-stu-id="8dfb9-443">ASP.NET SignalR 2.0.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.js

#### <a name="aspnet-signalr-201"></a><span data-ttu-id="8dfb9-444">ASP.NET SignalR 2.0。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-444">ASP.NET SignalR 2.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.js

#### <a name="aspnet-signalr-200"></a><span data-ttu-id="8dfb9-445">ASP.NET SignalR 2.0。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-445">ASP.NET SignalR 2.0.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.js

#### <a name="aspnet-signalr-113"></a><span data-ttu-id="8dfb9-446">ASP.NET SignalR 1.1。3</span><span class="sxs-lookup"><span data-stu-id="8dfb9-446">ASP.NET SignalR 1.1.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.js

#### <a name="aspnet-signalr-112"></a><span data-ttu-id="8dfb9-447">ASP.NET SignalR 1.1。2</span><span class="sxs-lookup"><span data-stu-id="8dfb9-447">ASP.NET SignalR 1.1.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.js

#### <a name="aspnet-signalr-111"></a><span data-ttu-id="8dfb9-448">ASP.NET SignalR 1.1。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-448">ASP.NET SignalR 1.1.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.js

#### <a name="aspnet-signalr-110"></a><span data-ttu-id="8dfb9-449">ASP.NET SignalR 1.1。0</span><span class="sxs-lookup"><span data-stu-id="8dfb9-449">ASP.NET SignalR 1.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.js

#### <a name="aspnet-signalr-101"></a><span data-ttu-id="8dfb9-450">ASP.NET SignalR 1.0。1</span><span class="sxs-lookup"><span data-stu-id="8dfb9-450">ASP.NET SignalR 1.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.js

<span data-ttu-id="8dfb9-451">有关 CDN 使用条款的信息，请参阅[Microsoft AJAX CDN 使用条款](https://www.asp.net/terms-of-use "Microsoft Ajax CDN 使用条款")。</span><span class="sxs-lookup"><span data-stu-id="8dfb9-451">For information about the terms of use for the CDN, see [Microsoft Ajax CDN Terms of Use](https://www.asp.net/terms-of-use "Microsoft Ajax CDN Terms of Use").</span></span>
